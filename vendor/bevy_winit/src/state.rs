...
pub fn winit_runner<T: Event>(mut app: App) -> AppExit {
    ...
    #[cfg(target_arch = "wasm32")]
    {
        ...
        // Browser callbacks outlive this stack frame. Transfer the complete
        // runner into the event loop instead of leaking a borrowed runner
        // through run_app's JavaScript exception.
    ...
    #[cfg(not(target_arch = "wasm32"))]
    {
        ...
        // The native loop exits after sending an exit code.
